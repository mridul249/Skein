...
type Application struct {
	...
	// startURL: Skein fork. See internal/app/app_production.go's CreateApp
	// doc comment for what this does and why it exists.
	startURL string
...
// NewWithOptionsAndStartURL is NewWithOptions with startURL threaded to
// CreateApp. Skein fork.
func NewWithOptionsAndStartURL(options *options.App, startURL string) *Application {
...
func (a *Application) Run() error {
	...
	application, err := app.CreateApp(a.options, a.startURL)
	if err != nil {
		return err
	}
